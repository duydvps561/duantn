  ...
  return (
    <nav className={styles.sidebar}>
      ...
      <div className={styles.logo}>
        <img src={logo.src} alt="Admin Logo" className={styles.logoImage} /> {/* Use imported logo */}
      </div>
    ...
    return (
      <li className={styles.menuItem}>
        <div onClick={toggleDropdown} className={styles.link}>
          ...
          <FontAwesomeIcon icon={faChevronDown} className={`${styles.icon} ${styles.svgIcon} ${isOpen ? styles.open : ''}`} />
        </div>
