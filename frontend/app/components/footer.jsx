    ...
    return(
        ...
        {/* <div className="d-flex justify-content-center align-items-center">
            <ul className="menu-bot d-flex ">
                ...
                <li className="nav-item"><a href="#" className="nav-link text-light">Hoi Dap</a></li>
                <li className="nav-item"><a href="/contact" className="nav-link text-light">Lien He</a></li>
            </ul>
        </div>
