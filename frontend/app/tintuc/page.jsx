                    ...
                    <div className="f-box" key={index}>
                        <Link href={`/tintuc/${item._id}`}>
                            <div className="box-img">
                                <img src="../../img/0017855.webp" alt="Tin tức" className="img-fluid" />
                            </div>
                            <div className='f-box-content'>
                            <p className='fs-7'>{new Date(item.createdAt).toLocaleDateString('vi-VN', { day: '2-digit', month: '2-digit', year: '2-digit' })}</p>
